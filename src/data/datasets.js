...
// Breed catalogue. Each entry carries everything the Fiche de race renders
// (histoire, traits, santé) so any breed can be selected — no longer a single
// hardcoded Cocker.
export const BREEDS = [
  { nom: 'Cocker Spaniel Anglais', groupe: 'Groupe 8', origine: 'Royaume-Uni', taille: '38–41 cm', poids: '13–14,5 kg', vie: '12–15 ans', tags: ['Affectueux', 'Joyeux', 'Sportif', 'Sensible'], traits: [['Énergie', 72], ["Facilité d'éducation", 75], ['Sociabilité', 90], ['Entretien du poil', 82]], histoire: 'Développé au pays de Galles et en Angleterre pour lever et rapporter la bécasse (« woodcock »), d’où son nom. Le plus petit des chiens de chasse leveurs britanniques, devenu chien de compagnie très populaire au XXe siècle.', sante: ['Otites (oreilles tombantes)', 'Atrophie rétinienne progressive', 'Dysplasie de la hanche', 'Affections oculaires', 'Surpoids si sous-exercé'], note: 'Oreilles tombantes à surveiller (otites). Idéal en famille active.' },
  { nom: 'Berger Australien', groupe: 'Groupe 1', origine: 'États-Unis', taille: '46–58 cm', poids: '16–32 kg', vie: '12–15 ans', tags: ['Intelligent', 'Actif', 'Loyal'], traits: [['Énergie', 95], ["Facilité d'éducation", 85], ['Sociabilité', 80], ['Entretien du poil', 65]], histoire: 'Malgré son nom, le « Aussie » a été fixé aux États-Unis au XIXe siècle pour la conduite de troupeaux, à partir de chiens de berger venus d’Europe avec les moutons australiens.', sante: ['Anomalie de l’œil du Colley', 'Épilepsie', 'Dysplasie de la hanche', 'Sensibilité médicamenteuse (gène MDR1)'], note: 'Très fort besoin de stimulation mentale et physique.' },
  { nom: 'Cavalier King Charles', groupe: 'Groupe 9', origine: 'Royaume-Uni', taille: '30–33 cm', poids: '5–8 kg', vie: '9–14 ans', tags: ['Doux', 'Câlin', 'Sociable'], traits: [['Énergie', 45], ["Facilité d'éducation", 70], ['Sociabilité', 95], ['Entretien du poil', 60]], histoire: 'Descendant des petits épagneuls de compagnie des cours royales anglaises, la race a été recréée au XXe siècle d’après les portraits d’époque pour retrouver le museau allongé d’origine.', sante: ['Maladie valvulaire mitrale', 'Syringomyélie', 'Affections oculaires', 'Otites'], note: 'Parfait en appartement. Sensible aux affections cardiaques.' },
  { nom: 'Husky Sibérien', groupe: 'Groupe 5', origine: 'Sibérie', taille: '50–60 cm', poids: '16–27 kg', vie: '12–15 ans', tags: ['Endurant', 'Indépendant', 'Vocal'], traits: [['Énergie', 95], ["Facilité d'éducation", 55], ['Sociabilité', 70], ['Entretien du poil', 70]], histoire: 'Élevé par le peuple Tchouktche de Sibérie orientale comme chien de traîneau d’endurance, il a été importé en Alaska au début du XXe siècle pour les courses et le travail.', sante: ['Cataracte', 'Atrophie rétinienne progressive', 'Dysplasie de la hanche', 'Affections dermatologiques'], note: "Grand fugueur, supporte mal la chaleur. ~2 h d'activité/jour." },
  { nom: 'Bouledogue Français', groupe: 'Groupe 9', origine: 'France', taille: '27–35 cm', poids: '8–14 kg', vie: '10–12 ans', tags: ['Calme', 'Affectueux', 'Drôle'], traits: [['Énergie', 40], ["Facilité d'éducation", 65], ['Sociabilité', 85], ['Entretien du poil', 30]], histoire: 'Issu des bouledogues miniatures anglais amenés en France par les ouvriers dentelliers au XIXe siècle, il est devenu un emblème de la vie parisienne.', sante: ['Syndrome brachycéphale', 'Hernies discales', 'Allergies cutanées', 'Difficultés respiratoires par forte chaleur'], note: 'Brachycéphale : respiration à surveiller, effort par temps chaud.' },
  { nom: 'Border Collie', groupe: 'Groupe 1', origine: 'Royaume-Uni', taille: '46–56 cm', poids: '12–20 kg', vie: '12–15 ans', tags: ['Vif', 'Brillant', 'Travailleur'], traits: [['Énergie', 98], ["Facilité d'éducation", 95], ['Sociabilité', 70], ['Entretien du poil', 60]], histoire: 'Chien de berger de la région frontalière anglo-écossaise (« border »), sélectionné sur ses seules aptitudes au travail et son regard hypnotique plutôt que sur l’apparence.', sante: ['Anomalie de l’œil du Colley', 'Épilepsie', 'Dysplasie de la hanche', 'Gène MDR1'], note: "La race la plus intelligente : s'ennuie vite sans occupation." },
  { nom: 'Golden Retriever', groupe: 'Groupe 8', origine: 'Royaume-Uni', taille: '51–61 cm', poids: '25–34 kg', vie: '10–12 ans', tags: ['Gentil', 'Patient', 'Fidèle'], traits: [['Énergie', 70], ["Facilité d'éducation", 90], ['Sociabilité', 95], ['Entretien du poil', 70]], histoire: 'Créé en Écosse au XIXe siècle par Lord Tweedmouth pour rapporter le gibier d’eau, par croisement de retrievers et de spaniels d’eau.', sante: ['Dysplasie de la hanche et du coude', 'Prédisposition à certains cancers', 'Affections cardiaques', 'Problèmes cutanés'], note: 'Excellent chien de famille. Sujet à la dysplasie.' },
  { nom: 'Beagle', groupe: 'Groupe 6', origine: 'Royaume-Uni', taille: '33–40 cm', poids: '9–11 kg', vie: '12–15 ans', tags: ['Curieux', 'Gourmand', 'Joueur'], traits: [['Énergie', 80], ["Facilité d'éducation", 55], ['Sociabilité', 85], ['Entretien du poil', 40]], histoire: 'Chien courant anglais utilisé en meute pour la chasse au lièvre, apprécié depuis des siècles pour son flair exceptionnel et son tempérament sociable.', sante: ['Épilepsie', 'Hypothyroïdie', 'Otites', 'Prise de poids / obésité'], note: 'Suit son flair : rappel difficile, tendance à la prise de poids.' },
  { nom: 'Carlin', groupe: 'Groupe 9', origine: 'Chine', taille: '25–30 cm', poids: '6–8 kg', vie: '12–15 ans', tags: ['Affectueux', 'Comique', 'Calme'], traits: [['Énergie', 35], ["Facilité d'éducation", 60], ['Sociabilité', 90], ['Entretien du poil', 40]], histoire: 'Race chinoise très ancienne, chien de compagnie favori des empereurs, importé en Europe par les marchands néerlandais à partir du XVIe siècle.', sante: ['Syndrome brachycéphale', 'Ulcères cornéens', 'Affections oculaires', 'Surpoids'], note: 'Très attaché à son maître. Respiration et yeux à surveiller.' },
  { nom: 'Berger Allemand', groupe: 'Groupe 1', origine: 'Allemagne', taille: '55–65 cm', poids: '22–40 kg', vie: '9–13 ans', tags: ['Loyal', 'Protecteur', 'Intelligent'], traits: [['Énergie', 85], ["Facilité d'éducation", 90], ['Sociabilité', 70], ['Entretien du poil', 65]], histoire: 'Standardisé en Allemagne à la fin du XIXe siècle par Max von Stephanitz comme chien de berger polyvalent, il est devenu l’un des chiens de travail les plus utilisés au monde.', sante: ['Dysplasie de la hanche et du coude', 'Myélopathie dégénérative', 'Ballonnement gastrique (torsion)', 'Allergies'], note: 'Polyvalent et fidèle. Prédisposé à la dysplasie de la hanche.' },
]
...
export const BEHAVIOR = [
  ...
  { case: 'Agressivité', ctx: 'Adulte · envers humains ou chiens', causes: ['Peur / défense (distance de sécurité)', 'Douleur ou problème de santé', 'Socialisation insuffisante'], exos: ['Augmentez la distance au déclencheur', 'Désensibilisation + contre-conditionnement', 'Bilan vétérinaire puis comportementaliste'], avoid: ['Punir les grognements (supprime l’avertissement)', 'Forcer le contact avec le déclencheur', 'Méthodes coercitives qui aggravent la peur'] },
  { case: 'Destruction en l’absence', ctx: 'Adulte · dégâts quand il est seul', causes: ['Ennui / dépense insuffisante', 'Anxiété de séparation', 'Énergie non canalisée'], exos: ['Longue sortie ou jeu avant de partir', 'Jouets d’occupation et de mastication', 'Espace sécurisé et confortable'], avoid: ['Gronder au retour', 'Laisser un accès total à toute la maison', 'Ignorer un éventuel mal-être'] },
  { case: 'Peur des inconnus', ctx: 'Adulte · recule, grogne ou se fige', causes: ['Manque de socialisation précoce', 'Mauvaise expérience passée', 'Tempérament prudent'], exos: ['Laissez-le observer à distance, à son rythme', 'Associez l’inconnu à des friandises', 'Progressez très graduellement'], avoid: ['Forcer les caresses des inconnus', 'Le mettre face à la personne d’un coup', 'Réprimander ses signaux de peur'] },
  { case: 'Tire en laisse', ctx: 'Tout âge · tracte en promenade', causes: ['Excitation / environnement stimulant', 'Allure naturelle plus rapide que la nôtre', 'Tirer a toujours fait avancer (renforcé)'], exos: ['Arrêt net dès que la laisse se tend', 'Récompensez la laisse détendue', 'Harnais anti-traction + séances courtes'], avoid: ['Coups de laisse / collier étrangleur', 'Avancer quand il tire', 'Promenades sans temps de reniflage'] },
  { case: 'Saute sur les gens', ctx: 'Excitation à l’accueil', causes: ['Demande d’attention / contact', 'Excitation à l’arrivée', 'Comportement récompensé sans le vouloir'], exos: ['Ignorez tant que les 4 pattes ne sont pas au sol', 'Récompensez « assis » pour saluer', 'Demandez aux visiteurs de faire pareil'], avoid: ['Repousser avec les mains (perçu comme un jeu)', 'Caresser quand il saute', 'Réactions bruyantes qui excitent'] },
  { case: 'Malpropreté', ctx: 'Fait ses besoins à l’intérieur', causes: ['Sorties trop espacées', 'Apprentissage de la propreté incomplet', 'Stress, marquage ou souci de santé'], exos: ['Sorties fréquentes (après sieste/repas/jeu)', 'Récompensez immédiatement dehors', 'Nettoyez à l’enzymatique (jamais à la javel)'], avoid: ['Mettre le nez dedans / punir', 'Le gronder après coup', 'Réduire l’eau sans avis vétérinaire'] },
  { case: 'Coprophagie', ctx: 'Mange ses crottes ou celles d’autres', causes: ['Comportement exploratoire (chiot)', 'Ennui / recherche d’attention', 'Carence ou trouble digestif possible'], exos: ['Ramassez immédiatement après élimination', 'Renforcez un « laisse » solide', 'Bilan vétérinaire si cela persiste'], avoid: ['Réagir vivement (devient un jeu)', 'Punir après coup', 'Négliger une cause médicale'] },
  { case: 'Ne revient pas au rappel', ctx: 'Ignore le rappel / fugue', causes: ['Rappel associé à la fin du plaisir', 'Environnement plus intéressant que vous', 'Rappel insuffisamment entraîné'], exos: ['Rappel toujours récompensé (jackpot)', 'Entraînez en longe avant le lâcher', 'Rendez-vous plus intéressant (jeux, friandises)'], avoid: ['Gronder quand il revient enfin', 'Rappeler seulement pour rentrer', 'Le lâcher trop tôt en milieu non maîtrisé'] },
  { case: 'Protection de ressources', ctx: 'Garde gamelle, jouets ou place', causes: ['Peur de perdre une ressource', 'Retraits forcés par le passé', 'Apprentissage / prédisposition'], exos: ['Échange : votre approche annonce mieux', 'Ne retirez jamais brusquement', 'Travaillez avec un pro si grognements'], avoid: ['Retirer la gamelle « pour montrer qui commande »', 'Punir les grognements', 'Provoquer la garde pour la tester'] },
  { case: 'Peur des bruits', ctx: 'Orages, feux d’artifice', causes: ['Sensibilité auditive', 'Absence d’habituation', 'Mauvaise expérience associée'], exos: ['Offrez un refuge sûr et au calme', 'Désensibilisation aux sons à faible volume', 'Diffuseurs apaisants / avis vétérinaire si panique'], avoid: ['Forcer l’exposition au bruit', 'Punir la peur', 'Le laisser seul lors d’un épisode intense'] },
  { case: 'Creuse des trous', ctx: 'Jardin · creuse régulièrement', causes: ['Ennui / besoin de dépense', 'Recherche de fraîcheur ou de proies', 'Instinct de race (terriers)'], exos: ['Augmentez l’exercice et la stimulation', 'Aménagez un bac à creuser autorisé', 'Cachez-y jouets et friandises'], avoid: ['Punir après coup', 'Le laisser seul et inactif au jardin', 'Reboucher sans offrir d’alternative'] },
  { case: 'Poursuite', ctx: 'Court après voitures, vélos, joggeurs', causes: ['Instinct de prédation', 'Excitation non canalisée', 'Comportement auto-récompensant'], exos: ['Travail du regard / focus sur vous', 'Augmentez la distance au déclencheur', 'Récompensez le calme avant la poursuite'], avoid: ['Le lâcher près des routes', 'Compter sur le rappel seul en pleine course', 'Punir sans gérer l’environnement'] },
  { case: 'Hyperactivité', ctx: 'Du mal à se poser', causes: ['Dépense physique / mentale insuffisante', 'Sur-stimulation chronique', 'Manque d’apprentissage du calme'], exos: ['Routines de retour au calme (tapis, mastication)', 'Activités de flair plutôt que jeux excitants', 'Temps de repos réguliers respectés'], avoid: ['Trop de jeux excitants (balle à répétition)', 'Le stimuler encore plus quand il s’excite', 'Manque de cadre et de sommeil'] },
]
