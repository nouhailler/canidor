...
export const INSTRUCTIONS = {
  ...
  translateJSON: "Ces images montrent un même chien (photo, ou frames extraites d'une courte vidéo). Interprète son langage corporel. Réponds UNIQUEMENT par un objet JSON valide, sans texte ni balises autour, au format exact : {\"emotion\":\"émotion dominante en 1 à 3 mots\",\"emoji\":\"un seul emoji\",\"confidence\":nombre 0-100,\"signals\":[{\"zone\":\"Oreilles|Queue|Posture|Regard|Gueule\",\"obs\":\"observation courte\"}],\"advice\":\"un conseil court et prudent\"}. Base-toi uniquement sur ce qui est visible, reste prudent. Réponds en français.",
  ...
  psy: (summary) => `Voici le profil psychologique estimé de mon chien : ${summary}. Rédige une analyse comportementale nuancée et bienveillante : personnalité dominante, motivations, points forts, points de vigilance, et 3 conseils d'éducation adaptés. Structure avec des puces courtes.`,
